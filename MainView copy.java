...
public class MainView extends JFrame {
	...
	ViewListModelTGB viewListModelTGB;//nguyen
	public MainView() {
		gui();
		createMenu();
	}
	...
	private void gui() {
		...
		viewListModelTGB = new	ViewListModelTGB();//nguyen
	}

	public ViewListModelTGB getViewListModelTGB() {//nguyen
		return viewListModelTGB;
	}
